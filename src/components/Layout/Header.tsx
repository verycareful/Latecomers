        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              {/* Admin/Dashboard Toggle Slider */}
              {isAdmin && (
                <div className="relative bg-gray-100 dark:bg-gray-700 rounded-full p-1">
                  <div className="relative flex items-center">
                    <Link
                      to="/"
                      className={`relative z-10 px-4 py-1.5 text-sm font-medium rounded-full transition-colors duration-200 ${!isOnAdminPage
                        ? 'text-white'
                    ...
                    {/* Sliding background */}
                    <div
                      className="absolute top-0 bottom-0 rounded-full bg-primary-600 transition-all duration-300 ease-out"
                      style={{
                        width: isOnAdminPage ? '60px' : '90px',
                        left: isOnAdminPage ? 'calc(100% - 64px)' : '0',
                      }}
                    />
                  </div>
                </div>
